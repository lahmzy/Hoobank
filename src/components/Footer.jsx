...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`mb-8 w-full flex-col md:flex-row ${styles.flexStart}`}>
      <div className="flex-1 justify-start mr-10 flex-col ">
      ...
      <div className="flex-[1.5] w-full flex flex-row justify-betweeen flex-wrap md:mt-0 mt-10">
